...
function overlayEntry(product){
  const offer={offer_id:`OFF-FIRST10-${product.canonical_ref}`,product_id:product.product_id,offer_class:'FREE',currency:'USD',amount:0};
  ...
  return Object.freeze({
    ...
    offer_summary:offer,
    commerce:{state:'FREE',currency:'USD',amount:0,offer_class:'FREE',offer_id:offer.offer_id,product_id:product.product_id},
...
export function firstCohortCommercialOverlay(){return Object.freeze({entries:Object.freeze(Object.fromEntries(FIRST_COHORT.map(product=>[product.canonical_ref,overlayEntry(product)])))});}
